package it.wlp.dev.repository;

import it.wlp.dev.DigitOrchApp;
import it.wlp.dev.config.Constants;
import it.wlp.dev.config.audit.AuditEventConverter;
import it.wlp.dev.domain.PersistentAuditEvent;
...
import static it.wlp.dev.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
